...
export const PlaceGallery = ({place}) => {
  ...
  return (
  <div className="relative md:mx-5 lg:mx-11">
    ...
    <button onClick={()=>setShowAllPhotos(true)} className="flex gap-1 text-sm absolute bottom-2 right-2 py-2 px-4 bg-white shadow-md shadow-gray-500 rounded-2xl">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
